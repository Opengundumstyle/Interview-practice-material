...
game plan:
receive array and a cb function;
create an empty array name trueArr ;
loop through given arr input each ele to cb();
if true, push ele to trueArr;
return trueArr at the end of loop;
